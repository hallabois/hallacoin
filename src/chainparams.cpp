...
{
    const char* pszTimestamp = "Kiitos kaikille, jotka osallistuivat eiliseen uusien 7. luokkalaisten info-iltaan.";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1621711933, 2086133534, 0x1e0ffff0, 1, 50 * COIN);
        ...
        //vSeeds.emplace_back("dnsseed.Hallacointools.com");
        //vSeeds.emplace_back("dnsseed.Hallacoinpool.org");

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,40);
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,5);
        base58Prefixes[SCRIPT_ADDRESS2] = std::vector<unsigned char>(1,50);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,40);
        base58Prefixes[EXT_PUBLIC_KEY] = {0x48, 0x88, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0x48, 0x88, 0xAD, 0xE4};
        ...
        checkpointData = {
            {
                {  0, uint256S("0x501ee72921297dd73ad65d8a769f83caa5dc50d64789ff9f26a50e7a45ca3b76")},
            }
        };
