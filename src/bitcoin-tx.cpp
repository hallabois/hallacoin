...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " Hallacoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  Hallacoin-tx [options] <hex-tx> [commands]  Update hex-encoded Hallacoin transaction\n" +
            "or:     Hallacoin-tx [options] -create [commands]   Create hex-encoded Hallacoin transaction\n" +
            "\n";
