...
"""Verify that starting Hallacoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start Hallacoin with -h for help text")
        ...
        self.log.info("Start Hallacoin with -version for version information")
        ...
        self.log.info("Start Hallacoind with -fakearg to make sure it does not start")
