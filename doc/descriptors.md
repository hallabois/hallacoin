# Support for Output Descriptors in Hallacoin Core

Since Hallacoin Core v0.17, there is support for Output Descriptors. This is a
...
on Hallacoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Hallacoin Core wallets, a convenience function `combo` is
